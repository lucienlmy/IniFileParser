...
public class IniFile
{
    ...
    /// <summary>
    /// List of INI file comments. Populated when reading a file. And all comments will
    /// be written to the top of the file when saving.
    /// </summary>
    public List<string?> Comments { get; private set; }

    /// <summary>
    /// If <see langword="true"/>, leading and trailing whitespace is removed from setting values.
    /// The default value is <see langword="false"/>, which preserves any whitespace in setting values.
    /// </summary>
    ...
    /// <param name="boolOptions">Optional settings for interpreting Boolean values.</param>
